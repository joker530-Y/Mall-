...
WHERE o.order_type = 1
  AND oi.promotion_name = CONCAT('baseline-seckill relationId=', @relation_id);
...
WHERE o.order_type = 1
  AND (
    o.promotion_info = CONCAT('baseline-seckill relationId=', @relation_id)
    OR oi.promotion_name = CONCAT('baseline-seckill relationId=', @relation_id)
  );
